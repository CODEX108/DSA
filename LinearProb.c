...
int main() {
    ...
    insert_key_value(ht, "first name", "Your first name");
    insert_key_value(ht, "last name", "Your last name");
    insert_key_value(ht, "uid", "Your UID");
    insert_key_value(ht, "sport", "Your favorite sport");
    insert_key_value(ht, "food", "Your favorite food");
    insert_key_value(ht, "holiday", "Your favorite holiday destination");
    insert_key_value(ht, "role_model", "Your role model");
    insert_key_value(ht, "subject", "Your favorite subject");
    insert_key_value(ht, "song", "Your favorite song");
    insert_key_value(ht, "movie", "Your favorite movie");
    insert_key_value(ht, "colour", "Your favorite color");
    insert_key_value(ht, "book", "Your favorite book");
